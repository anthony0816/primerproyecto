    ...
    <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto border border-gray-200">
      ...
      <div className="p-6">
        {atenciones.length > 0 ? (
              ...
              <li key={atencion.id} className="pt-4 first:pt-0">
                ...
                {atencion.consulta && (
                  <p className="mt-1 text-sm text-gray-600">
                    <span className="font-semibold">Diagnostico:</span> {atencion.consulta.diagnostico || 'N/A'}
                    <span className="font-semibold">Tratamiento:</span> {atencion.consulta.tratamiento || 'N/A'}
                  </p>
                )}
                {atencion.vacunacion && (
                  <p className="mt-1 text-sm text-gray-600">
                    <span className="font-semibold">Vacuna:</span> {atencion.vacunacion.vacuna || 'N/A'}
                  </p>
                )}
              </li>
            ))}
          ...
          <p className="text-center py-4 text-gray-500">No hay atenciones registradas</p>
        )}
      </div>
